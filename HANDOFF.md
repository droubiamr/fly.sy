...
| UI direction | **B — "Passport"**: calm, light, cool-grey ground, passport-green `#0E5C3F` accent, outlined *stamp* chips for status, Geist (Latin) + IBM Plex Sans Arabic (Arabic; weights 500/600/700 only, 400 served Medium), both self-hosted |
