import { AE, AM, AT, BE, CH, DE, DK, EG, FR, GB, IQ, JO, KW, LB, LY, NL, NO, OM, QA, RO, RU, SA, SE, SY, TR } from "country-flag-icons/react/3x2"
...
const FLAGS = { AE, AM, AT, BE, CH, DE, DK, EG, FR, GB, IQ, JO, KW, LB, LY, NL, NO, OM, QA, RO, RU, SA, SE, SY, TR } as const
