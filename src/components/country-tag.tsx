...
export function CountryTag({ code }: { code: string }) {
  return (
    <span className="inline-flex shrink-0 items-center gap-1 rounded-sm bg-muted px-1.5 py-px font-mono text-[10px] font-semibold tracking-wider text-muted-foreground">
