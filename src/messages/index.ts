...
const messages = {
  ar: {
    ...
    estimates: "تقديرات تشمل انتظار المعبر",
    road: "الطريق البري",
    to: "إلى",
    need: "ما تحتاجه",
    ...
    route: {
      ...
      lede: "كل طريق نعرفه من {origin} إلى {city}، مرتباً حسب الوقت الكلي، ولكل سطر مصدره.",
  ...
  en: {
    ...
    estimates: "Estimates, including the border wait",
    road: "Road",
    to: "to",
    need: "What you need",
    ...
    route: {
      ...
      lede: "Every route we know from {origin} to {city}, ranked by total time, each with its source.",
