...
The brand mark is `src/app/icon.svg`: Syria in white on a passport-green tile, with the lucide plane taking off across its north-east border. Everything raster
